      ...
      <div className="px-4 py-16 space-y-8">
        {[1, 2, 3, 4, 5, 6].map((_, index) => (
          <div key={index} className="flex flex-col items-start">
            ...
            <div className="flex items-center justify-between w-full mt-5 font-medium text-gray-500">
              <span>니꼬</span>
              <span>18시간 전</span>
            </div>
            <div className="flex space-x-5 mt-4 text-gray-700 py-2.5 border-t border-b-[2px] w-full">
